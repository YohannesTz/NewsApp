...
public class Util {
    ...
    public static String WEBAPIADRESS = "http://10.0.3.2/newsapplication/api.php";
    public static String NEWS_DETAILAPI = "http://192.168.137.1/news/getDetail.php";
    public static String UPLOADIMAGEADRESS = "http://addisnews.000webhostapp.com/news/upload.php";
